...
from   data_utils_v2 import data_helpers, tag_data_helpers

from model_new_2.abuse_classifier import AbuseClassifier
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        # save models
        if FLAGS.checkpoint == "":
            out_dir = os.path.abspath(os.path.join(os.path.pardir, "model_new_2"))
            print("Writing to {}\n".format(out_dir))
        else:
